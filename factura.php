...
<body>
  <nav class="navbar navbar-dark bg-dark">
    <div class="container">
      <a class="navbar-brand" href="factura.php">Factura</a>
    </div>
    <div>
          ...
          <table class="table table-bordered">
            ...
            <tbody>
              ...
              while ($row = mysqli_fetch_assoc($result)) { ?>
                <tr>
                  <td><?php echo $row['idfact']; ?></td>
                  <td><?php echo $row['fechafact']; ?></td>
                  <td><?php echo $row['ivafact']; ?></td>
                  <td><?php echo $row['subtotalfact']; ?></td>
                  <td><?php echo $row['totalfact']; ?></td>
                  <td><?php echo $row['idcliente']; ?></td>
                  <td>
                    <a title="eliminar usuario/cliente" href="delete.php?id=<?php echo $row['idcliente'] ?>" class="btn btn-danger">
                        <i class="fa-solid fa-user-slash"></i>
                    </a>
                    <a title="actualizar usuario" href="facturar()" class="btn btn-secondary">
